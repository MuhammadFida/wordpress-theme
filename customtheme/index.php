                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-md-4 col-sm-12 col-xs-12">
                            <div class="intro-image">
                                <img src="<?php echo get_template_directory_uri(); ?>/images/intro-image.jpg" alt="">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row no-gutters filtr-container">
                    <div class="col-md-4 col-sm-12 col-xs-12 filtr-item" data-category="3">
                        <div class="content-image">
                            <a href="<?php echo get_template_directory_uri(); ?>/images/portfolio1.jpg" class="portfolio-popup">
                                <img src="<?php echo get_template_directory_uri(); ?>/images/portfolio1.jpg" alt="">
                    ...
                    <div class="col-md-4 col-sm-12 col-xs-12 filtr-item" data-category="1">
                        <div class="content-image">
                            <a href="<?php echo get_template_directory_uri(); ?>/images/portfolio2.jpg" class="portfolio-popup">
                    ...
                    <div class="col-md-4 col-sm-12 col-xs-12 filtr-item" data-category="2, 1">
                        <div class="content-image">
                            <a href="<?php echo get_template_directory_uri(); ?>/images/portfolio3.jpg" class="portfolio-popup">
                    ...
                    <div class="col-md-4 col-sm-12 col-xs-12 filtr-item" data-category="3">
                        <div class="content-image">
                            <a href="<?php echo get_template_directory_uri(); ?>/images/portfolio4.jpg" class="portfolio-popup">
                    ...
                    <div class="col-md-4 col-sm-12 col-xs-12 filtr-item" data-category="1, 2">
                        <div class="content-image">
                            <a href="<?php echo get_template_directory_uri(); ?>/images/portfolio5.jpg" class="portfolio-popup">
                    ...
                    <div class="col-md-4 col-sm-12 col-xs-12 filtr-item" data-category="3, 1">
                        <div class="content-image">
                            <a href="<?php echo get_template_directory_uri(); ?>/images/portfolio6.jpg" class="portfolio-popup">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="content">
                        <div class="image">
                            <img src="<?php echo get_template_directory_uri(); ?>/images/blog1.jpg" alt="">
                        </div>
                ...
                <div class="col-md-6">
                    <div class="content no-mb">
                        <div class="image">
                            <img src="<?php echo get_template_directory_uri(); ?>/images/blog2.jpg" alt="">
                        </div>
                        <div class="blog-title">
